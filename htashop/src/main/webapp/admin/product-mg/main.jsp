...
%>
					<tr class="d-flex">
						<td class="col-2"><%=product.getNo() %></td>
			...
			<ul class="pagination justify-content-center">
				<!-- 이전버튼 -->
   				<li class="page-item <%=!pagination.isExistPrev() ? "disabled" : "" %>">
     					<a class="page-link bg-white text-black" href="index.jsp?pageNo=<%=pagination.getPrevPage() %>" aria-label="Previous">
...
%>
    			<li class="page-item <%=pagination.getPageNo() == num ? "active" : "" %>"><a class="page-link bg-white text-black" href="main.jsp?pageNo=<%=num%>"><%=num %></a></li>
<%
	}
%>
   				<!-- 다음버튼 -->
   				<li class="page-item <%=!pagination.isExistNext() ? "disabled" : "" %>">
     					<a class="page-link bg-white text-black" href="index.jsp?pageNo=<%=pagination.getNextPage() %>" aria-label="Next">
