	...
	<div class="container">
		<div class="row">
			...
			<div class="col-11">
				...
				<div class="container">
					<div class="btn-group">
						<a href="reviewManagement.jsp" class="btn btn-primary active" aria-current="page">리뷰</a> <a href="qaBoardManagement.jsp" class="btn btn-primary">QA</a>
					</div>
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td>QA</td>
								<td>
									<a id="new-link" href="../qa-board/detail.jsp?no=<%=qaboard.getNo()%>"><%=qaboard.getTitle()%></a>
								</td>
				...
				<div class="row text-center">
					<form id="form-search" method="get" action="qaBoardManagement.jsp">
						...
						<button class="btn btn-primary" type="button" onclick="searchBoards(1)">검색</button>
					</form>
				</div>
			</div>
		</div>
