	...
	<div class="container">
		<div class="row">
			...
			<div class="col-11">
				...
				<div class="container">
					<div class="btn-group">
						<a href="reviewManagement.jsp" class="btn btn-primary active">리뷰</a> <a href="qaBoardManagement.jsp" class="btn btn-primary">QA</a>
					</div>
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td>Review</td>
								<td>
									<a id="new-link" href="../products/reviewDetail.jsp?reviewNo=<%=review.getReviewNo()%>"><%=review.getTitle()%></a>
								</td>
				...
				<div class="row text-center">
					<div class="container">
						<ul class="pagination justify-content-center">
							<li class="page-item <%=pagination.isExistPrev() ? "" : "disabled"%>"><a href="" class="page-link" onclick="moveToPage(event, <%=pagination.getPrevPage()%>)" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
							<%
								for (int no = pagination.getBeginPage(); no <= pagination.getEndPage(); no++) {
							%>
							<li class="page-item <%=no == pagination.getPageNo() ? "active" : ""%>"><a href="" class="page-link" onclick="moveToPage(event, <%=no%>)"><%=no%></a></li>
							<%
								}
							%>
				...
				<div class="row text-center">
					<form id="form-search" method="get" action="reviewManagement.jsp">
