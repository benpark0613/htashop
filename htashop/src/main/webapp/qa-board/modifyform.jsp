...
<div class="container">
	<div class="row mb-3">
		...
		<form method="post" action="modify.jsp?">
			...
			<input type="hidden" name="productNo" value="<%=qaBoard.getProductNo()%>">
			...
			<table class="table border p-3 bg-light">
				<tbody>
					...
					<tr class="d-flex">
						...
						<td class="col-4">
							<select name="title">
							<option selected="selected" disabled="disabled" value="<%=qaBoard.getTitle()%>"><%=qaBoard.getTitle()%></option>
					...
					<tr class="d-flex">
						...
						<td class="col-10"><textarea rows="20" class="form-control" name="content" style="resize: none;"><%=qaBoard.getContent() %></textarea></td>
					</tr>
					<tr class="d-flex">
			...
			<div class="mb-3 text-end">
				<a href="detail.jsp?no=<%=qaBoard.getNo() %>" class="btn btn-secondary">취소</a>
