...
%>
   ...
   <input class="btn btn-outline-dark" type='submit' id="no"value='장바구니' onclick='return submit2(this.form);'>
   </form>
...
%>                      
               <tr class="d-flex">
                  ...
                  <td class="col-5"><a href="reviewDetail.jsp?reviewNo=<%=review.getReviewNo()%>&pageNo=<%=pageNo%>"><%=review.getTitle()%></a></td>
