...
<body>
<%
	pageContext.setAttribute("menu", "bottomIndex");
			...
			<ul class="pagination justify-content-center">
				<!-- 이전버튼 -->
   				<li class="page-item <%=!paginationIndex.isExistPrev() ? "disabled" : "" %>">
     					<a class="page-link bg-white text-black" href="bottomIndex.jsp?pageNo=<%=paginationIndex.getPrevPage() %>" aria-label="Previous">
...
%>
    			<li class="page-item <%=paginationIndex.getPageNo() == num ? "active" : "" %>"><a class="page-link bg-white text-black" href="bottomIndex.jsp?pageNo=<%=num%>"><%=num %></a></li>
<%
	}
%>
   				<!-- 다음버튼 -->
   				<li class="page-item <%=!paginationIndex.isExistNext() ? "disabled" : "" %>">
     					<a class="page-link bg-white text-black" href="bottomIndex.jsp?pageNo=<%=paginationIndex.getNextPage() %>" aria-label="Next">
