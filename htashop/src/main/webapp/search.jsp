			...
			<div class="row mt-3 mb-3">
				<div class="col">
					<form class="d-flex justify-content-center" id="form-search" name="search" method="post" action="search.jsp">
						...
						<!--  -->
						<div>
							<select id="keyword" onchange="categoryChange(this)">
								<option>검색키워드를 선택하세요.</option>
								<option value="price">가격</option>
								<option value="categoty">키워드</option>
							</select>
...
<script>
	function {
		var keyword_price = ["낮은가격순", "높은가격순"]
		var keyword_category = ["top, bottom"]
	}
</script>
</body>
</html>