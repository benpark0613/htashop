...
<nav class="navbar navbar-expand navbar-dark bg-dark">
	...
	<div class="container">
		<ul class="navbar-nav me-auto">
			<li class="nav-item"><a class="nav-link active" href="/htashop/admin/admin-index.jsp">마이몰현황</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="/htashop/admin/customer-mg/customer-mg.jsp">고객관리</a></li>
