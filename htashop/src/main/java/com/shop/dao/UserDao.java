...
public class UserDao {
	...
	public List<User> getAllUsers() throws SQLException {
		String sql = "select USER_NO, USER_TYPE, USER_ID, USER_PASSWORD, USER_EMAIL, USER_NAME, "
				...
				+ "USER_CREATED_DATE, USER_POINT, USER_IN_OUT, USER_GRADE " + "from shop_user ";
	...
	/**
	 * 지정된 아이디에 해당하는 사용자 정보를 반환한다. 해당 아이디로 가입한 사용자가 없는 경우 null이 반환될 수 있다.
	 * 
	 * @param id 아이디
	 * @return 사용자 정보
	 * @throws SQLException
	...
	public User getUserById(String id) throws SQLException {
		...
		String sql = "select USER_NO, USER_TYPE, USER_ID, USER_PASSWORD, USER_EMAIL, USER_NAME, "
				+ "USER_BIRTHDAY, USER_TEL, USER_GENDER, USER_ADDRESS, "
				+ "USER_CREATED_DATE, USER_POINT, USER_IN_OUT, USER_GRADE " + "from shop_user " + "where USER_ID = ? ";
	...
	/**
	 * 지정된 이메일 주소에 해당하는 사용자 정보를 반환한다. 해당 이메일로 가입한 사용자가 없는 경우 null이 반환될 수 있다.
	 * 
	 * @param email 이메일
	 * @return 사용자 정보
	 * @throws SQLException
	...
	public User getUserByNo(int no) throws SQLException {
		String sql = "select USER_NO, USER_TYPE, USER_ID, USER_PASSWORD, USER_EMAIL, USER_NAME, "
				+ "USER_BIRTHDAY, USER_TEL, USER_GENDER, USER_ADDRESS, "
				+ "USER_CREATED_DATE, USER_POINT, USER_IN_OUT, USER_GRADE " + "from shop_user " + "where USER_NO = ? ";
	...
	public void updateUser(User user) throws SQLException {
		...
		String sql = "update SHOP_USER " + "set " + "USER_NAME = ?, " + "USER_PASSWORD = ?, " + "USER_BIRTHDAY = ?, "
				+ "USER_TEL = ?, " + "USER_ADDRESS = ?, " + "USER_EMAIL = ? " + "where USER_NO = ? ";
		Connection connection = getConnection();
		PreparedStatement pstmt = connection.prepareStatement(sql);
